...
- c500 -> c501 after this pass: `24.7-24.8 s` in repeated measurements
- c500 -> c505 in-memory continuation after this pass: `122.8 s`, about
  `24.6 s/cycle`
- conservative mature-state speedup: about `1.62x` versus the same c500
