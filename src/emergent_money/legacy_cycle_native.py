    ...
    def plan_exchange_basket(
        ...
        *,
        ...
        kwargs = dict(
            ...
            exchange_media_reserve_bias=config.experimental_exchange_media_reserve_bias,
            exchange_media_reserve_min_acceptance=config.experimental_exchange_media_reserve_min_acceptance,
            exchange_media_reserve_bootstrap_floor=config.experimental_exchange_media_reserve_bootstrap_floor,
